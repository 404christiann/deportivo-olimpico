...
import { TryoutsAdmin } from "./TryoutsAdmin";

export type AdminKind = "dashboard"|"roster"|"schedule"|"seasons"|"stats"|"sponsors"|"store"|"analytics"|"standings"|"tryouts";
